...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3,4], n = 4, left = 1, right = 5
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3,4], n = 4, left = 3, right = 4
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3,4], n = 4, left = 1, right = 10
